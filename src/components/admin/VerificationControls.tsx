    ...
    <div className="bg-slate-950 p-6 rounded-2xl border border-slate-800 space-y-6">
      ...
      <div className="pt-2 flex flex-wrap gap-2.5">
        ...
        <button
          ...
          className="px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-extrabold transition shadow-lg flex items-center gap-1.5 cursor-pointer"
        >
          <CheckCircle2 className="w-4 h-4" /> Approve & Confirm Membership
        </button>
        ...
        <button
          ...
          className="px-3.5 py-2 rounded-xl bg-red-600/20 hover:bg-red-600 text-red-300 hover:text-white text-xs font-bold transition border border-red-500/30 flex items-center gap-1.5 cursor-pointer"
        >
        ...
        {status === 'approved_verified' && (
          <button
            ...
            className="px-3.5 py-2 rounded-xl bg-purple-600/20 hover:bg-purple-600 text-purple-300 hover:text-white text-xs font-bold transition border border-purple-500/30 cursor-pointer"
          >
            Suspend / Revoke
          </button>
        )}
      ...
      {status === 'approved_verified' && (
        <div className="pt-4 border-t border-slate-800 space-y-3">
          <h4 className="text-xs font-bold text-emerald-400 uppercase tracking-wider flex items-center gap-1.5">
            <ShieldCheck className="w-4 h-4" /> Digital Accreditation Active
          </h4>
          <p className="text-xs text-slate-400">
            Digital membership confirmation is active for this forum. PDF letter generation is currently suspended. Coordinators can view and screenshot their official confirmation card on the public status portal.
          </p>
        </div>
      )}
    </div>
