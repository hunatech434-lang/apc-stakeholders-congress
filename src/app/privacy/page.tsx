      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="bg-white p-8 sm:p-12 rounded-3xl border border-slate-200 shadow-sm space-y-6 text-slate-700 text-xs sm:text-sm leading-relaxed">
          ...
          <section className="space-y-2">
            ...
            <p>
              Personal telephone numbers and email addresses submitted during registration are strictly restricted to authorized Directorate verification officers and system administrators. They are never published in the public Verified Groups Directory or exposed to search engine crawlers.
            </p>
          </section>
