...
import { generateRegistrationRef, generateVerificationToken } from '../src/lib/refGenerator.js';
import { normalizeNigerianPhone } from '../src/lib/phoneNormalizer.js';
import { fullRegistrationSchema } from '../src/lib/validators.js';
import { generateCertificatePdf, generateLetterOfRecognitionPdf } from '../src/lib/documentGenerator.js';
